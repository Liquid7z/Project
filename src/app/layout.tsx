...
import { Inter, Space_Grotesk, Caveat, Source_Code_Pro } from 'next/font/google';
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={cn("dark", fontBody.variable, fontHeadline.variable, fontHandwriting.variable, fontCode.variable)}>
      <head>
